...
#ifndef __GLFWPOMPEII_INPUT__
#define __GLFWPOMPEII_INPUT__
...
namespace pompeii
{
  ...
  public:
	...
	GLFWPOMPEII_API
	static pompeii::Keyboard* Keyboard( void );
	GLFWPOMPEII_API
	static pompeii::Mouse* Mouse( void );
	GLFWPOMPEII_API
  ...
  protected:
	pompeii::Keyboard* _keyboard;
	pompeii::Mouse* _mouse;
