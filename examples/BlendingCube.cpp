...
// Code based on http://learningwebgl.com/blog/?p=859

namespace material
{
  class BlendingMaterial: public lava::engine::Material
  {
  public:
    struct
    {
      ...
      std::shared_ptr<RenderPass> renderPass )
    {
      ...
      PipelineShaderStageCreateInfo vertexStage = dev->createShaderPipelineShaderStage(
        LAVA_EXAMPLES_SPV_ROUTE + std::string( "cubeUVBlending_vert.spv" ),
        vk::ShaderStageFlagBits::eVertex
      );
      PipelineShaderStageCreateInfo fragmentStage = dev->createShaderPipelineShaderStage(
        LAVA_EXAMPLES_SPV_ROUTE + std::string( "cubeUVBlending_frag.spv" ),
        vk::ShaderStageFlagBits::eFragment
      );
      ...
      vk::PipelineDepthStencilStateCreateInfo depthStencil( {}, false, true, vk::CompareOp::eLessOrEqual, false, false, stencilOpState, stencilOpState, 0.0f, 0.0f );
      vk::PipelineColorBlendAttachmentState colorBlendAttachment( true, vk::BlendFactor::eSrcAlpha, vk::BlendFactor::eOne, vk::BlendOp::eAdd, vk::BlendFactor::eZero, vk::BlendFactor::eZero, vk::BlendOp::eAdd,
...
const std::vector<material::BlendingMaterial::Vertex> vertices =
{
...
public:
  ...
  std::shared_ptr<material::BlendingMaterial> material;
    ...
    : VulkanApp( title, width, height )
  {
    // Vertex buffer
    {
      uint32_t vertexBufferSize = vertices.size( ) * sizeof( material::BlendingMaterial::Vertex );
    ...
    material = std::make_shared<material::BlendingMaterial>( );
  ...
  void updateUniformBuffers( void )
  {
    ...
    material->uboVS.model = glm::rotate( material->uboVS.model, time * glm::radians( 90.0f ), glm::vec3( 0.0f, 0.0f, 1.0f ) );
    material->uboVS.model = glm::rotate( material->uboVS.model, time * 0.1f * glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f));
