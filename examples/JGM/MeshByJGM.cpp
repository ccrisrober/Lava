...
std::string meshByJGMVertexShader( "/home/jguerrero/opt/Lava/spvs/JGM/meshByJGM_vert.spv" );
std::string meshByJGMFragmentShader( "/home/jguerrero/opt/Lava/spvs/JGM/meshByJGM_frag.spv" );
...
class HelloTriangleApplication
{
  ...
  private:
    ...
    void createGraphicsPipeline( void )
    {
      ...
      auto vertShaderCode = readFile( meshByJGMVertexShader );
      auto fragShaderCode = readFile( meshByJGMFragmentShader );
