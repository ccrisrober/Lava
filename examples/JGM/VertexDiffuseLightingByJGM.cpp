/**
 * Lava.
 * File: VertexDiffuseLightingByJGM.cpp
...
std::string vertexDiffuseLightingByJGMVertexShader( "/home/jguerrero/opt/Lava/spvs/JGM/vertexDiffuseLightingByJGM_vert.spv" );
std::string vertexDiffuseLightingByJGMFragmentShader( "/home/jguerrero/opt/Lava/spvs/JGM/vertexDiffuseLightingByJGM_frag.spv" );
...
class HelloTriangleApplication
{
  ...
  private:
    ...
    void createGraphicsPipeline( void )
    {
      ...
      auto vertShaderCode = readFile( vertexDiffuseLightingByJGMVertexShader );
      auto fragShaderCode = readFile( vertexDiffuseLightingByJGMFragmentShader );
    ...
    **/
    ...
    void updateUniformBuffer( void )
    {
      ...
      ubo.view = glm::lookAt( glm::vec3( 0.0f, 0.01f, 5.0f ),
