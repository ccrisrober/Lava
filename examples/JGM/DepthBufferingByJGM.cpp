...
std::string triangleVS( "/home/jguerrero/opt/Lava/spvs/JGM/depthBufferingByJGM_vert.spv" );
std::string triangleFS( "/home/jguerrero/opt/Lava/spvs/JGM/depthBufferingByJGM_frag.spv" );
