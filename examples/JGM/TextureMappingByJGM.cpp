...
std::string triangleVS( "/home/jguerrero/opt/Lava/spvs/JGM/textureMappingByJGM_vert.spv" );
std::string triangleFS( "/home/jguerrero/opt/Lava/spvs/JGM/textureMappingByJGM_frag.spv" );
