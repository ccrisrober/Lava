/**
 * Lava.
 * File: SkyboxReflectionAndRefractionByJGM.cpp
...
// Meshes.
// Mesh 1: Cube.
std::string cubeMeshPath = LAVA_EXAMPLES_MESHES_ROUTE + std::string("cube2.obj_");
lava::extras::ModelImporter cubeModel( cubeMeshPath );
lava::extras::Mesh cubeMesh = cubeModel._meshes[ 0 ];

// Mesh 2: Monkey.
std::string monkeyMeshPath = LAVA_EXAMPLES_MESHES_ROUTE + std::string("ogreAngry.obj_");
lava::extras::ModelImporter monkeyModel( monkeyMeshPath );
lava::extras::Mesh monkeyMesh = monkeyModel._meshes[ 0 ];
...
{
  LAVA_EXAMPLES_IMAGES_ROUTE + std::string("seaCubemap/right.jpg"),
  LAVA_EXAMPLES_IMAGES_ROUTE + std::string("seaCubemap/left.jpg"),
  LAVA_EXAMPLES_IMAGES_ROUTE + std::string("seaCubemap/top.jpg"),
  LAVA_EXAMPLES_IMAGES_ROUTE + std::string("seaCubemap/bottom.jpg"),
  LAVA_EXAMPLES_IMAGES_ROUTE + std::string("seaCubemap/back.jpg"),
  LAVA_EXAMPLES_IMAGES_ROUTE + std::string("seaCubemap/front.jpg")
};
/**/
// Option 2: darkskies.
/**
std::array< std::string, 6 > skyboxPaths =
{
  LAVA_EXAMPLES_IMAGES_ROUTE + std::string("darkskiesCubemap/right.tga"),
  LAVA_EXAMPLES_IMAGES_ROUTE + std::string("darkskiesCubemap/left.tga"),
  LAVA_EXAMPLES_IMAGES_ROUTE + std::string("darkskiesCubemap/top.tga"),
  LAVA_EXAMPLES_IMAGES_ROUTE + std::string("darkskiesCubemap/bottom.tga"),
  LAVA_EXAMPLES_IMAGES_ROUTE + std::string("darkskiesCubemap/back.tga"),
  LAVA_EXAMPLES_IMAGES_ROUTE + std::string("darkskiesCubemap/front.tga")
};
**/
// Option 3: farwest.
/**
std::array< std::string, 6 > skyboxPaths =
{
  LAVA_EXAMPLES_IMAGES_ROUTE + std::string("farwestCubemap/right.tga"),
  LAVA_EXAMPLES_IMAGES_ROUTE + std::string("farwestCubemap/left.tga"),
  LAVA_EXAMPLES_IMAGES_ROUTE + std::string("farwestCubemap/top.tga"),
  LAVA_EXAMPLES_IMAGES_ROUTE + std::string("farwestCubemap/bottom.tga"),
  LAVA_EXAMPLES_IMAGES_ROUTE + std::string("farwestCubemap/back.tga"),
  LAVA_EXAMPLES_IMAGES_ROUTE + std::string("farwestCubemap/front.tga")
};
**/

/** Shaders. They must be in *.spv Vulkan format. **/
std::string skyboxByJGMVertexShader( "/home/jguerrero/opt/Lava/spvs/JGM/skyboxByJGM_vert.spv" );
std::string skyboxByJGMFragmentShader( "/home/jguerrero/opt/Lava/spvs/JGM/skyboxByJGM_frag.spv" );

std::string skyboxReflectionAndRefractionByJGMVertexShader( "/home/jguerrero/opt/Lava/spvs/JGM/skyboxReflectionAndRefractionByJGM_vert.spv" );
std::string skyboxReflectionAndRefractionByJGMFragmentShader( "/home/jguerrero/opt/Lava/spvs/JGM/skyboxReflectionAndRefractionByJGM_frag.spv" );
...
class HelloTriangleApplication
{
  ...
  private:
    ...
    glm::vec3 defaultCameraPosition = glm::vec3( 0.0f, 0.01f, 0.7f );
    std::vector< VkPushConstantRange > pushConstantRangesForMonkey;
    VkPipelineLayout pipelineLayoutForMonkey;

    glm::mat4 defaultModelMatrix = glm::mat4( 1.0f );
    glm::mat4 monkeyModelMatrix = glm::mat4( 1.0f );
    std::vector< VkPushConstantRange > pushConstantRangesForSkybox;
    VkPipelineLayout pipelineLayoutForSkybox;

    // Pipeline.
    VkPipeline graphicsPipelineForMonkey;
    VkPipeline graphicsPipelineForSkybox;
     ...
     */
    VkBuffer monkeyVertexBuffer;
    VkDeviceMemory monkeyVertexBufferMemory;
    VkBuffer monkeyIndexBuffer;
    VkDeviceMemory monkeyIndexBufferMemory;
    ...
    void initVulkan( void )
    {
      ...
      createPushConstantRangesForMonkey( );
      createPushConstantRangesForSkybox( );

      /**
       * Pipeline.
       */
      createGraphicsPipelineForMonkey( );
      createGraphicsPipelineForSkybox( );
       ...
       * Vertex and index buffer.
       */
      createMonkeyVertexBuffer( );
      createMonkeyIndexBuffer( );
    ...
    void cleanupSwapChain( void )
    {
       ...
       * Pipeline.
       */
      vkDestroyPipeline( device, graphicsPipelineForMonkey, nullptr );
      vkDestroyPipeline( device, graphicsPipelineForSkybox, nullptr );

      /**
       * PipelineLayout.
       */
      vkDestroyPipelineLayout( device, pipelineLayoutForMonkey, nullptr );
      vkDestroyPipelineLayout( device, pipelineLayoutForSkybox, nullptr );
    ...
    void cleanup( void )
    {
      ...
      vkDestroyBuffer( device, monkeyIndexBuffer, nullptr );
      vkFreeMemory( device, monkeyIndexBufferMemory, nullptr );
      vkDestroyBuffer( device, monkeyVertexBuffer, nullptr );
      vkFreeMemory( device, monkeyVertexBufferMemory, nullptr );
    ...
    void createDescriptorSetLayout( void )
    {
      ...
      cubeSamplerLayoutBinding.pImmutableSamplers = nullptr; // Optional
      cubeSamplerLayoutBinding.stageFlags = VK_SHADER_STAGE_FRAGMENT_BIT;

      std::array< VkDescriptorSetLayoutBinding, 2 > bindings =
        { uboLayoutBinding,
          cubeSamplerLayoutBinding };
    ...
    void createPushConstantRangesForMonkey( void )
    {
      ...
      pushConstantRangesForMonkey.push_back( vertexShaderPushConstant );
      pushConstantRangesForMonkey.push_back( fragmentShaderPushConstant );
    }

    void createPushConstantRangesForSkybox( void )
    {
      VkPushConstantRange vertexShaderPushConstant =
      { VK_SHADER_STAGE_VERTEX_BIT, 0, 16 * sizeof( float ) };

      pushConstantRangesForSkybox.push_back( vertexShaderPushConstant );
    }

    void createGraphicsPipelineForMonkey( void )
    {
      // Getting shaders byte array.
      auto vertShaderCode = readFile( skyboxReflectionAndRefractionByJGMVertexShader );
      auto fragShaderCode = readFile( skyboxReflectionAndRefractionByJGMFragmentShader );
      ...
      **/
      ...
      pipelineLayoutInfo.pushConstantRangeCount = pushConstantRangesForMonkey.size( );
      pipelineLayoutInfo.pPushConstantRanges = pushConstantRangesForMonkey.data( );

      if( vkCreatePipelineLayout( device, &pipelineLayoutInfo, nullptr, &pipelineLayoutForMonkey ) != VK_SUCCESS )
      {
      ...
      pipelineInfo.layout = pipelineLayoutForMonkey;
      pipelineInfo.renderPass = firstRenderPass;
      pipelineInfo.subpass = 0;
      pipelineInfo.basePipelineHandle = VK_NULL_HANDLE; // Optional
      pipelineInfo.basePipelineIndex = -1; // Optional

      if( vkCreateGraphicsPipelines( device, VK_NULL_HANDLE, 1, &pipelineInfo, nullptr, &graphicsPipelineForMonkey ) != VK_SUCCESS )
      {
    ...
    void createGraphicsPipelineForSkybox( void )
    {
      // Getting shaders byte array.
      auto vertShaderCode = readFile( skyboxByJGMVertexShader );
      auto fragShaderCode = readFile( skyboxByJGMFragmentShader );
      ...
      vertexInputInfo.sType = VK_STRUCTURE_TYPE_PIPELINE_VERTEX_INPUT_STATE_CREATE_INFO;
      // BEGIN vk::Name (C++ style) to VkName conversion.
      VkVertexInputBindingDescription bindingDescription = lava::extras::Vertex::getBindingDescriptionOnlyPosition( );
      auto cPlusPlusAttributeDescriptions = lava::extras::Vertex::getAttributeDescriptions( );
      ...
      // If it is greater than 1 -> you must use a GPU feature.
      rasterizer.lineWidth = 1.0f;
      // For a skybox we will use VK_CULL_MODE_FRONT_BIT instead of VK_CULL_MODE_BACK_BIT.
      ...
      **/
      ...
      pipelineLayoutInfo.setLayoutCount = 1;
      pipelineLayoutInfo.pSetLayouts = &descriptorSetLayout;
      pipelineLayoutInfo.pushConstantRangeCount = pushConstantRangesForSkybox.size( );
      pipelineLayoutInfo.pPushConstantRanges = pushConstantRangesForSkybox.data( );

      if( vkCreatePipelineLayout( device, &pipelineLayoutInfo, nullptr, &pipelineLayoutForSkybox ) != VK_SUCCESS )
      {
        throw std::runtime_error( "failed to create pipeline layout!" );
      }
      ...
      pipelineInfo.pColorBlendState = &colorBlending;
      pipelineInfo.pDynamicState = nullptr; // Optional
      pipelineInfo.layout = pipelineLayoutForSkybox;
      pipelineInfo.renderPass = firstRenderPass;
      pipelineInfo.subpass = 0;
      pipelineInfo.basePipelineHandle = VK_NULL_HANDLE; // Optional
      pipelineInfo.basePipelineIndex = -1; // Optional

      if( vkCreateGraphicsPipelines( device, VK_NULL_HANDLE, 1, &pipelineInfo, nullptr, &graphicsPipelineForSkybox ) != VK_SUCCESS )
      {
        throw std::runtime_error( "failed to create graphics pipeline!" );
      }
    ...
    void createSkyboxImage( void )
    {
      // 1: Creating a single staging buffer with all images data.
      VkDeviceSize skyboxImagesSize = 0;
      // WARNING: considering 6 faces.
      std::array< unsigned char*, 6 > skyboxImagesPixelsPointers;
      // WARNING: considering all equal.
      int texWidth, texHeight, texChannels;
      VkDeviceSize imageSize = 0;
      for( unsigned int i = 0; i < skyboxPaths.size( ); ++i )
      {
        stbi_uc* pixels =
          stbi_load( skyboxPaths[i].c_str( ),
                     &texWidth, &texHeight, &texChannels, STBI_rgb_alpha);
        if( !pixels )
        {
          throw std::runtime_error( "failed to load a skybox image!" );
        }
        // 4 bytes (32 bits) per pixel. 1 byte (unsigned char) per channel.
        // WARNING: texChannels is 3 but we are going to force 4.
        imageSize = texWidth * texHeight * 4 * sizeof( unsigned char );
        //std::cout << "texWidth: " << texWidth << std::endl;
        //std::cout << "texHeight: " << texHeight << std::endl;
        //std::cout << "texChannels: " << texChannels << std::endl;
        //std::cout << "imageSize: " << imageSize << std::endl;
        skyboxImagesSize += imageSize;
        skyboxImagesPixelsPointers[ i ] = pixels;
      }
      unsigned char* skyboxImagesPixels = ( unsigned char* ) malloc( skyboxImagesSize );
      unsigned char* skyboxImagesPixelsIterator = skyboxImagesPixels;
      for( unsigned int i = 0; i < skyboxPaths.size( ); ++i )
      {
        memcpy( skyboxImagesPixelsIterator, skyboxImagesPixelsPointers[ i ], imageSize );
        skyboxImagesPixelsIterator += imageSize / sizeof( unsigned char );
      }
      for( unsigned int i = 0; i < skyboxPaths.size( ); ++i )
      {
        free( skyboxImagesPixelsPointers[ i ] );
      }
      ...
      createBuffer( skyboxImagesSize, VK_BUFFER_USAGE_TRANSFER_SRC_BIT,
      ...
      // Mapping.
      void* data;
      vkMapMemory( device, stagingBufferMemory, 0, skyboxImagesSize, 0, &data );
      memcpy( data, skyboxImagesPixels, static_cast< size_t >( skyboxImagesSize ) );
      vkUnmapMemory( device, stagingBufferMemory );

      free( skyboxImagesPixels );

      createImageForSkybox(
        texWidth, texHeight, static_cast< uint32_t >( skyboxPaths.size( ) ),
      ...
      imageSubresourceRange.layerCount = static_cast< uint32_t >( skyboxPaths.size( ) );

      // Changing image layout.
      transitionImageLayoutForSkybox( skyboxImage,
                                      VK_IMAGE_LAYOUT_UNDEFINED,
                                      VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL,
                                      imageSubresourceRange );

      // BEGIN copyBufferToImage method.
      VkCommandBuffer commandBuffer = beginSingleTimeCommands( );

      // VkBufferImageCopy vector.
      ...
      for( unsigned int i = 0; i < skyboxPaths.size( ); ++i )
      {
        ...
        bufferImageCopy.imageExtent.width = texWidth;
        bufferImageCopy.imageExtent.height = texHeight;
      ...
      vkCmdCopyBufferToImage( commandBuffer, stagingBuffer, skyboxImage,
                              VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL,
                              static_cast< uint32_t >( skyboxPaths.size( ) ),
                              bufferImageCopies.data( ) );

      endSingleTimeCommands( commandBuffer );
      // END copyBufferToImage method.
    ...
    void createSkyboxImageView( void )
    {
      skyboxImageView = createImageViewForSkybox( skyboxImage,
                                                  VK_FORMAT_R8G8B8A8_UNORM,
                                                  VK_IMAGE_ASPECT_COLOR_BIT );
    }

    void createSkyboxSampler( void )
    {
    ...
    VkImageView createImageViewForSkybox( VkImage image, VkFormat format,
                                          VkImageAspectFlags aspectFlags )
    {
      VkImageViewCreateInfo viewInfo = {};
      viewInfo.sType = VK_STRUCTURE_TYPE_IMAGE_VIEW_CREATE_INFO;
    ...
    void createImageForSkybox( uint32_t width, uint32_t height,
    ...
    void transitionImageLayoutForSkybox( VkImage image,
                                         VkImageLayout oldLayout,
                                         VkImageLayout newLayout,
    ...
    void createCubeVertexBuffer( void )
    {
      // Cube.

      VkDeviceSize cubeBufferSize = sizeof( cubeMesh.vertices[0].position ) * cubeMesh.numVertices;

      // Staging buffer.
      VkBuffer cubeStagingBuffer;
      VkDeviceMemory cubeStagingBufferMemory;
      createBuffer( cubeBufferSize,
                    VK_BUFFER_USAGE_TRANSFER_SRC_BIT,
                    VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT |
                    VK_MEMORY_PROPERTY_HOST_COHERENT_BIT,
                    cubeStagingBuffer,
                    cubeStagingBufferMemory );

      // Data mapping.
      void* cubeData;
      vkMapMemory( device, cubeStagingBufferMemory, 0, cubeBufferSize, 0, &cubeData );
      memcpy( cubeData, cubeMesh.vertexPositions.data( ), (size_t) cubeBufferSize );
      vkUnmapMemory( device, cubeStagingBufferMemory );
      ...
      copyBuffer( cubeStagingBuffer, cubeVertexBuffer, cubeBufferSize );

      vkDestroyBuffer( device, cubeStagingBuffer, nullptr );
      vkFreeMemory( device, cubeStagingBufferMemory, nullptr );
    }

    void createCubeIndexBuffer( void )
    {
      // Cube.

      VkDeviceSize cubeBufferSize = sizeof( cubeMesh.indices[0] ) * cubeMesh.numIndices;
      ...
      void* cubeData;
      vkMapMemory( device, cubeStagingBufferMemory, 0, cubeBufferSize, 0, &cubeData );
      memcpy( cubeData, cubeMesh.indices.data( ), (size_t) cubeBufferSize );
      vkUnmapMemory( device, cubeStagingBufferMemory );
      ...
      copyBuffer( cubeStagingBuffer, cubeIndexBuffer, cubeBufferSize );

      vkDestroyBuffer( device, cubeStagingBuffer, nullptr );
      vkFreeMemory( device, cubeStagingBufferMemory, nullptr );
    }

    void createMonkeyVertexBuffer( void )
    {
      // Monkey.

      VkDeviceSize monkeyBufferSize = sizeof( monkeyMesh.vertices[0] ) * monkeyMesh.numVertices;

      // Staging buffer.
      VkBuffer monkeyStagingBuffer;
      VkDeviceMemory monkeyStagingBufferMemory;
      createBuffer( monkeyBufferSize,
                    VK_BUFFER_USAGE_TRANSFER_SRC_BIT,
                    VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT |
                    VK_MEMORY_PROPERTY_HOST_COHERENT_BIT,
                    monkeyStagingBuffer,
                    monkeyStagingBufferMemory );

      // Data mapping.
      void* monkeyData;
      vkMapMemory( device, monkeyStagingBufferMemory, 0, monkeyBufferSize, 0, &monkeyData );
      memcpy( monkeyData, monkeyMesh.vertices.data( ), (size_t) monkeyBufferSize );
      vkUnmapMemory( device, monkeyStagingBufferMemory );
      ...
      createBuffer( monkeyBufferSize,
                    ...
                    VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT,
                    monkeyVertexBuffer,
                    monkeyVertexBufferMemory );

      copyBuffer( monkeyStagingBuffer, monkeyVertexBuffer, monkeyBufferSize );

      vkDestroyBuffer( device, monkeyStagingBuffer, nullptr );
      vkFreeMemory( device, monkeyStagingBufferMemory, nullptr );
    }

    void createMonkeyIndexBuffer( void )
    {
      // Monkey.

      VkDeviceSize monkeyBufferSize = sizeof( monkeyMesh.indices[0] ) * monkeyMesh.numIndices;
      ...
      void* monkeyData;
      vkMapMemory( device, monkeyStagingBufferMemory, 0, monkeyBufferSize, 0, &monkeyData );
      memcpy( monkeyData, monkeyMesh.indices.data( ), (size_t) monkeyBufferSize );
      vkUnmapMemory( device, monkeyStagingBufferMemory );
      ...
      createBuffer( monkeyBufferSize,
                    ...
                    VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT,
                    monkeyIndexBuffer,
                    monkeyIndexBufferMemory );

      copyBuffer( monkeyStagingBuffer, monkeyIndexBuffer, monkeyBufferSize );
    ...
    void updateDescriptorSet( void )
    {
      ...
      cubeImageInfo.imageView = skyboxImageView;
      cubeImageInfo.sampler = skyboxSampler;
      ...
      descriptorWrites[1].pImageInfo = &cubeImageInfo;
    ...
    void createCommandBuffers( void )
    {
      ...
      // VertexBuffers.
      VkBuffer monkeyVertexBuffers[] = { monkeyVertexBuffer };
      VkDeviceSize monkeyVertexBufferOffsets[] = { 0 };

      VkBuffer cubeVertexBuffers[] = { cubeVertexBuffer };
      VkDeviceSize cubeVertexBufferOffsets[] = { 0 };
      ...
      for( size_t i = 0; i < commandBuffers.size( ); i++ )
      {
        ...
        vkCmdBeginRenderPass( commandBuffers[i], &firstRenderPassInfo, VK_SUBPASS_CONTENTS_INLINE );
          ...
          vkCmdBindPipeline( commandBuffers[i], VK_PIPELINE_BIND_POINT_GRAPHICS, graphicsPipelineForMonkey );

          // Working with buffers.
          vkCmdBindVertexBuffers( commandBuffers[i], 0, 1,
                                  monkeyVertexBuffers, monkeyVertexBufferOffsets );

          // To read meshes it is better to use VK_INDEX_TYPE_UINT32 instead of VK_INDEX_TYPE_UINT16.
          vkCmdBindIndexBuffer( commandBuffers[i], monkeyIndexBuffer, 0, VK_INDEX_TYPE_UINT32 );

          // Descriptor sets: a uniform buffer (view and proj).
          vkCmdBindDescriptorSets( commandBuffers[i], VK_PIPELINE_BIND_POINT_GRAPHICS,
                                   pipelineLayoutForMonkey, 0, 1, &descriptorSet, 0, nullptr );

          monkeyModelMatrix[ 0 ].x = 0.2f;
          monkeyModelMatrix[ 1 ].y = 0.2f;
          monkeyModelMatrix[ 2 ].z = 0.2f;

          vkCmdPushConstants( commandBuffers[i], pipelineLayoutForMonkey,
          ...
          vkCmdDrawIndexed(
            commandBuffers[i],
            static_cast< uint32_t >( monkeyMesh.numIndices ),
            1, 0, 0, 0 );

          // 2: Skybox.

          vkCmdBindPipeline( commandBuffers[i], VK_PIPELINE_BIND_POINT_GRAPHICS, graphicsPipelineForSkybox );

          // Working with buffers.
          vkCmdBindVertexBuffers( commandBuffers[i], 0, 1,
                                  cubeVertexBuffers, cubeVertexBufferOffsets );
          ...
          // Descriptor sets: a uniform buffer (view and proj).
          vkCmdBindDescriptorSets( commandBuffers[i], VK_PIPELINE_BIND_POINT_GRAPHICS,
                                   pipelineLayoutForSkybox, 0, 1, &descriptorSet, 0, nullptr );

          vkCmdPushConstants( commandBuffers[i], pipelineLayoutForSkybox,
                              VK_SHADER_STAGE_VERTEX_BIT,
                              0, 16 * sizeof( float ),
                              &defaultModelMatrix );
          ...
          vkCmdDrawIndexed(
            commandBuffers[i],
            static_cast< uint32_t >( cubeMesh.numIndices ),
            1, 0, 0, 0 );
