...
class HelloTriangleApplication
{
  ...
  private:
    ...
    // Binding 0.
    glm::vec3 defaultCameraPosition = glm::vec3( 0.0f, 0.01f, 0.0f );
    ...
    void createVertexBuffers( void )
    {
      ...
      VkDeviceSize cubeBufferSize = sizeof( cubeMesh.vertices[0] ) * cubeMesh.numVertices;
      ...
      memcpy( cubeData, cubeMesh.vertices.data( ), (size_t) cubeBufferSize );
