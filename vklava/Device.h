...
namespace lava
{
	...
	{
	public:
		static std::shared_ptr<Device> create(const std::shared_ptr<PhysicalDevice>& phyDev,
		...
		vk::DeviceMemory allocateMemReqMemory(const vk::MemoryRequirements& reqs, vk::MemoryPropertyFlags flags);
