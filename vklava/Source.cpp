...
public:
		...
		: VulkanApp( title, width, height )
	{
		...
		std::shared_ptr<ShaderModule> vertexShaderModule = _device->createShaderModule(VKLAVA_EXAMPLES_RESOURCES_ROUTE + std::string("/vert.spv"));
		std::shared_ptr<ShaderModule> fragmentShaderModule = _device->createShaderModule(VKLAVA_EXAMPLES_RESOURCES_ROUTE + std::string("/frag.spv"));*/
	}
